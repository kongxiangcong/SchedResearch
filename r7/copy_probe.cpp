...
int main(int argc,char** argv) {
  ...
  try {
    ...
    for(int iteration=0;iteration<repetitions;++iteration) {
      ...
      const auto launch_start=Clock::now(); t=launch_start;
      ...
      const double visible_s=seconds(launch_start);
      ...
      std::cout<<"{\"stage\":\"result\",\"iteration\":"<<iteration<<",\"state\":"<<state<<",\"host_launch_wait2_s\":"<<launch_wait_s<<",\"sync_from_device_s\":"<<from_device_s<<",\"launch_to_output_sync_s\":"<<visible_s<<",\"verify_hash_s\":"<<verify_s<<",\"compared_words\":"<<words<<",\"mismatches\":"<<mismatches<<",\"input_unchanged\":"<<(after_sha==input_sha?"true":"false")<<",\"output_sha256\":\""<<output_sha<<"\",\"numeric_pass\":"<<(!mismatches&&output_sha==input_sha&&after_sha==input_sha?"true":"false")<<"}\n";
